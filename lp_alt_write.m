function lp_alt_write ( filename, label, m, n, a, b )

%*****************************************************************************80
%
%% lp_alt_write() writes linear programming data to an LP file.
%
%  Discussion:
%
%    This version of lp_write() uses an alternative form of the objective.
%
...
%
  ...
  if ( output < 0 ) 
    fprintf ( 1, '\n' );
    fprintf ( 1, 'lp_alt_write(): Error!\n' );
    fprintf ( 1, '  Could not open the output file.\n' );
    error ( 'lp_alt_write(): Error!' );
  end

  fprintf ( output, '%s\n', label );
  fprintf ( output, '\n' );
%
%  Use the alternative objective function formulation:
%
