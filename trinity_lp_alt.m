function trinity_lp_alt ( )

%*****************************************************************************80
%
%% trinity_lp_alt() creates an LP file describing the trinity puzzle.
%
%  Discussion:
%
%    An alternative form of the objective function is to be used.
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'trinity_lp_alt():\n' );
  fprintf ( 1, '  Define the trinity puzzle and a set of tiles.\n' );
  ...
  fprintf ( 1, '  An alternative form for the objective function is to be used.\n' );
%
...
%
  filename = 'trinity_alt.lp';
  label = '\ trinity alt LP';
  lp_alt_write ( filename, label, eqn_num, var_num, A, b );

  fprintf ( 1, '\n' );
  fprintf ( 1, '  trinity system computed.\n' );
  fprintf ( 1, '  matrix A has %d rows, %d columns, %d nonzeros\n', ...
    eqn_num, var_num, nz_num );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  trinity information saved as "%s"\n', filename );
%
%  Terminate.
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'trinity_alt_lp():\n' );
