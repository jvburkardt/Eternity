function [ w, p_ij ] = boat_tile_word ( boat_id )

%*****************************************************************************80
%
%% boat_tile_word() returns the boundary word for a boat tile.
%
%  Discussion:
%
...
%
  eternity_id = boat_tile_id ( boat_id );
