function [ w, p_ij ] = boomerang_tile_word ( boomerang_id )

%*****************************************************************************80
%
%% boomerang_tile_word() returns the boundary word for a boomerang tile.
%
%  Discussion:
%
...
%  Input:
%
%    integer boomerang_id: a tile index.
%
%  Output:
%
...
%
  eternity_id = boomerang_tile_id ( boomerang_id );
