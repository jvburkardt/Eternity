function [ imin, imax, jmin, jmax ] = word_range_ij ( w, p_ij )

%*****************************************************************************80
%
%% word_range_ij() gets the (i,j) range of an object from its boundary word.
%
%  Discussion:
%
...
%  Output:
%
%    real IMIN, IMAX, JMIN, JMAX, the range of the object.
%
