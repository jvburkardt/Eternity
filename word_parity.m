function parity = word_parity ( w )

%*****************************************************************************80
%
%% word_parity() returns the parity of an object from its boundary word.
%
%  Discussion:
%
...
%  Output:
%
%    integer PARITY: the parity of the object.
%
  p_ij = [ 0, 0 ];
%
