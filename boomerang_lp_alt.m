function boomerang_alt_lp ( )

%*****************************************************************************80
%
%% boomerang_alt_lp() creates an LP file describing the boomerang puzzle.
%
%  Discussion:
%
%    An alternative form of the objective function is used.
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'boomerang_alt_lp():\n' );
  fprintf ( 1, '  Define the boomerang puzzle and a set of tiles.\n' );
  ...
  fprintf ( 1, '  An alternative form of the objective function is used.\n' );
%
...
%
          [ w_s, pij_s ] = boomerang_tile_word ( s );
%
...
%
  filename = 'boomerang_alt.lp';
  label = '\ boomerang alt LP';
  lp_alt_write ( filename, label, eqn_num, var_num, A, b );

  fprintf ( 1, '\n' );
  fprintf ( 1, '  boomerang system computed.\n' );
  fprintf ( 1, '  matrix A has %d rows, %d columns, %d nonzeros\n', ...
    eqn_num, var_num, nz_num );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  boomerang information saved as "%s"\n', filename );
%
%  Terminate.
%
  fprintf ( 1, '\n' );
