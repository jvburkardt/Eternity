function [ w, p_ij ] = trinity_tile_word ( trinity_id )

%*****************************************************************************80
%
%% trinity_tile_word() returns the boundary word for a trinity tile.
%
%  Discussion:
%
...
%  Input:
%
%    integer TRINITY_ID: a tile index.
%
%  Output:
%
...
%
  eternity_id = trinity_tile_id ( trinity_id );
