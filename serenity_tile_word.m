function [ w, p_ij ] = serenity_tile_word ( serenity_id )

%*****************************************************************************80
%
%% serenity_tile_word() returns the boundary word for a serenity tile.
%
%  Discussion:
%
...
%  Input:
%
%    integer serenity_id: a tile index.
%
%  Output:
%
...
%
  eternity_id = serenity_tile_id ( serenity_id );
