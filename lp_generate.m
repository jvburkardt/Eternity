function lp_generate ( label, tile_num, tile_word, grid_word )

%*****************************************************************************80
%
%% lp_generate() generates an LP file for the tiling of a region.
%
%  Discussion:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'lp_generate():\n' );
  fprintf ( 1, '  Define a puzzle grid and set of tiles.\n' );
