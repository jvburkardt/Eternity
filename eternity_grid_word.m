function [ w, p_ij ] = eternity_grid_word ( )

%*****************************************************************************80
%
%% eternity_grid_word() returns the boundary word for the eternity grid.
%
%  Discussion:
%
...
%
%  Choose the base point so that (0,0) is at center of the grid.
%
  p_ij = [ 0, 0 ];
%
%  For symmetry, we start at the "3 o'clock" position.
%
  w = [ ...
    'DddDDddD', ...
    'EEEEEEEEEEEEEE', ...
