function [ w, p_ij ] = whale_tile_word ( whale_id )

%*****************************************************************************80
%
%% whale_tile_word() returns the boundary word for a whale grid tile.
%
%  Discussion:
%
...
%
  eternity_id = whale_tile_id ( whale_id );
